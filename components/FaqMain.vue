            ...
            <div class="c-accordion-list">
              <div class="c-accordion-item" @click="toggle(0)">
                <div class="_w-accordion-item">
                  ...
                  <div id="accordion-des0" class="c-accordion-item-a">
              ...
              <div id="accordion-item1" class="c-accordion-item" @click="toggle(1)">
                <div class="_w-accordion-item">
                  <div class="c-accordion-item-q">
                    <div class="_w-accordion-item-q">
                      <div class="c-accordion-item-q-text">
                  ...
                  <div id="accordion-des1" class="c-accordion-item-a">
                    <div class="_w-accordion-content-divider">
                      <div class="accordion-content-divider"></div>
                    </div>
                    <div class="_w-accordion-item-a">
              ...
              <div id="accordion-item2" class="c-accordion-item" @click="toggle(2)">
                <div class="_w-accordion-item">
                  <div class="c-accordion-item-q">
                    <div class="_w-accordion-item-q">
                      <div class="c-accordion-item-q-text">
                  ...
                  <div id="accordion-des2" class="c-accordion-item-a">
                    <div class="_w-accordion-content-divider">
                      <div class="accordion-content-divider"></div>
                    </div>
                    <div class="_w-accordion-item-a">
              ...
              <div id="accordion-item3" class="c-accordion-item" @click="toggle(3)">
                <div class="_w-accordion-item">
                  <div class="c-accordion-item-q">
                    <div class="_w-accordion-item-q">
                      <div class="c-accordion-item-q-text">
                  ...
                  <div id="accordion-des3" class="c-accordion-item-a">
                    <div class="_w-accordion-content-divider">
                      <div class="accordion-content-divider"></div>
                    </div>
                    <div class="_w-accordion-item-a">
              ...
              <div id="accordion-item4" class="c-accordion-item" @click="toggle(4)">
                <div class="_w-accordion-item">
                  <div class="c-accordion-item-q">
                    <div class="_w-accordion-item-q">
                      <div class="c-accordion-item-q-text">
                  ...
                  <div id="accordion-des4" class="c-accordion-item-a">
                    <div class="_w-accordion-content-divider">
                      <div class="accordion-content-divider"></div>
                    </div>
                    <div class="_w-accordion-item-a">
              ...
              <div id="accordion-item5" class="c-accordion-item" @click="toggle(5)">
                <div class="_w-accordion-item">
                  <div class="c-accordion-item-q">
                    <div class="_w-accordion-item-q">
                      <div class="c-accordion-item-q-text">
                  ...
                  <div id="accordion-des5" class="c-accordion-item-a">
                    <div class="_w-accordion-content-divider">
                      <div class="accordion-content-divider"></div>
                    </div>
                    <div class="_w-accordion-item-a">
              ...
              <div id="accordion-item6" class="c-accordion-item" @click="toggle(6)">
                <div class="_w-accordion-item">
                  <div class="c-accordion-item-q">
                    <div class="_w-accordion-item-q">
                      <div class="c-accordion-item-q-text">
                  ...
                  <div id="accordion-des6" class="c-accordion-item-a">
                    <div class="_w-accordion-content-divider">
                      <div class="accordion-content-divider"></div>
                    </div>
                    <div class="_w-accordion-item-a">
              ...
              <div id="accordion-item7" class="c-accordion-item" @click="toggle(7)">
                <div class="_w-accordion-item">
                  <div class="c-accordion-item-q">
                    <div class="_w-accordion-item-q">
                      <div class="c-accordion-item-q-text">
                  ...
                  <div id="accordion-des7" class="c-accordion-item-a">
                    <div class="_w-accordion-content-divider">
                      <div class="accordion-content-divider"></div>
                    </div>
                    <div class="_w-accordion-item-a">
              ...
              <div id="accordion-item8" class="c-accordion-item" @click="toggle(8)">
                <div class="_w-accordion-item">
                  <div class="c-accordion-item-q">
                    <div class="_w-accordion-item-q">
                      <div class="c-accordion-item-q-text">
                  ...
                  <div id="accordion-des8" class="c-accordion-item-a">
                    <div class="_w-accordion-content-divider">
                      <div class="accordion-content-divider"></div>
                    </div>
                    <div class="_w-accordion-item-a">
              ...
              <div id="accordion-item9" class="c-accordion-item" @click="toggle(9)">
                <div class="_w-accordion-item">
                  <div class="c-accordion-item-q">
                    <div class="_w-accordion-item-q">
                      <div class="c-accordion-item-q-text">
                  ...
                  <div id="accordion-des9" class="c-accordion-item-a">
                    <div class="_w-accordion-content-divider">
                      <div class="accordion-content-divider"></div>
                    </div>
                    <div class="_w-accordion-item-a">
...
<script>
  export default {
    data() {
      return {
        itemArrays: [false, false, false, false, false, false, false, false, false],
        temp: "",
      };
    },
    methods: {
