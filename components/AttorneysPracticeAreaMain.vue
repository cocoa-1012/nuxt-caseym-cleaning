<template>
  <div class="home-mobile">
    ...
    <div class="real-estate-title-services-section wf-section spec13">
      ...
      <div
        class="experienced-attorneys-text about-subtext-hero desktop-view"
        style="margin-top: 125px; margin-bottom: -370px"
      >
        <img
          src="assets/images/Mask Group 24.jpg"
          loading="lazy"
          alt=""
          class="desktop-view"
        />
    ...
    <div class="why-choose-us about-us-contact-banner wf-section">
      ...
      <div
        class="wcu-images wcu-section-about w-row"
    ...
    <div class="real-estate-title-services-section wf-section spec04">
      <div
        ...
        style="margin-top: 30px; margin-bottom: -30px; color: #892432"
      >
        Donec Euismod Ornare Sodales Morbi Gravida <br />Er Metus Eget Fermentum
      </div>
      <div
        class="
          workingwithtextsection
