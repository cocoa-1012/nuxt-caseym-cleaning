<template>
  <div class="workingwithtextsection w-row practice">
    ...
    <div class="w-col w-col-6">
      <p class="working-with-subtext practice">
        ...
        mattis sapien venenatis at. <br /><br />Donec et eros eros. Phasellus
        arcu mi, hendrerit eu nibh eu, condimentum iaculis sapien. Donec eu
