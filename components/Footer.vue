<template>
  <div class="footer wf-section">
    <div class="main-content-container w-container">
      <div class="experienced-attorneys-text footer-font">
      ...
      <div class="footer-content w-row">
        ...
        <div class="w-col w-col-8 footer-parent">
          <div class="w-col w-col-3 footer-child">
            ...
            >
              <p class="footer-text">
                <span class="footer-sub-title"> OFFICE </span>
                <br />105 Tivoli Street<br />Abbeville, LA<br />
              </p>
            </a>
          ...
          <div class="w-col w-col-3 footer-child second">
            <p class="footer-text linked" style="color: #54788e">
              <a href="/contact" style="text-decoration: none; color: #54788e">
                Contact
              </a>
              <br />
              <a
      ...
      <div v-show="isOpenContact" class="w-col footer-contact-form">
